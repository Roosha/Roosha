...
class Scrutiny : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:roosha.Scrutiny) */ {
 public:
  ...
  inline Scrutiny* New() const { return New(NULL); }

  Scrutiny* New(::google::protobuf::Arena* arena) const;
 ...
 private:
  ...
  friend void  protobuf_AddDesc_learning_2eproto();
  friend void protobuf_AssignDesc_learning_2eproto();
  friend void protobuf_ShutdownFile_learning_2eproto();

  void InitAsDefaultInstance();
  static Scrutiny* default_instance_;
};
// ===================================================================
