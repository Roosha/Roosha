 ...
 public:
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status knock(::grpc::ClientContext* context, const ::roosha::Void& request, ::roosha::Void* response) override;
    ...
    ::grpc::Status registrate(::grpc::ClientContext* context, const ::roosha::Credentials& request, ::roosha::AuthenticationToken* response) override;
    ...
    ::grpc::Status authorize(::grpc::ClientContext* context, const ::roosha::Credentials& request, ::roosha::AuthenticationToken* response) override;
    ...
    ::grpc::Status translate(::grpc::ClientContext* context, const ::roosha::TranslationRequest& request, ::roosha::Translations* response) override;
    ...
    ::grpc::Status proposeUserTranslations(::grpc::ClientContext* context, const ::roosha::Translations& request, ::roosha::Void* response) override;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::roosha::Void>* AsyncknockRaw(::grpc::ClientContext* context, const ::roosha::Void& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::roosha::AuthenticationToken>* AsyncregistrateRaw(::grpc::ClientContext* context, const ::roosha::Credentials& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::roosha::AuthenticationToken>* AsyncauthorizeRaw(::grpc::ClientContext* context, const ::roosha::Credentials& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::roosha::Translations>* AsynctranslateRaw(::grpc::ClientContext* context, const ::roosha::TranslationRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class WithAsyncMethod_knock : public BaseClass {
   ...
   public:
    ...
    ~WithAsyncMethod_knock() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status knock(::grpc::ServerContext* context, const ::roosha::Void* request, ::roosha::Void* response) final override {
      abort();
  ...
  class WithAsyncMethod_registrate : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status registrate(::grpc::ServerContext* context, const ::roosha::Credentials* request, ::roosha::AuthenticationToken* response) final override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_authorize : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status authorize(::grpc::ServerContext* context, const ::roosha::Credentials* request, ::roosha::AuthenticationToken* response) final override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_translate : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status translate(::grpc::ServerContext* context, const ::roosha::TranslationRequest* request, ::roosha::Translations* response) final override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_proposeUserTranslations : public BaseClass {
   ...
   public:
    ...
    ~WithAsyncMethod_proposeUserTranslations() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status proposeUserTranslations(::grpc::ServerContext* context, const ::roosha::Translations* request, ::roosha::Void* response) final override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_saveChanges : public BaseClass {
   ...
   public:
    ...
    ~WithAsyncMethod_saveChanges() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status saveChanges(::grpc::ServerContext* context, ::grpc::ServerReader< ::roosha::Change>* reader, ::roosha::Void* response) final override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_loadChanges : public BaseClass {
   ...
   public:
    ...
    ~WithAsyncMethod_loadChanges() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
  ...
  class WithGenericMethod_knock : public BaseClass {
   ...
   public:
    ...
    ~WithGenericMethod_knock() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status knock(::grpc::ServerContext* context, const ::roosha::Void* request, ::roosha::Void* response) final override {
  ...
  class WithGenericMethod_proposeUserTranslations : public BaseClass {
   ...
   public:
    ...
    ~WithGenericMethod_proposeUserTranslations() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status proposeUserTranslations(::grpc::ServerContext* context, const ::roosha::Translations* request, ::roosha::Void* response) final override {
  ...
  class WithGenericMethod_saveChanges : public BaseClass {
   ...
   public:
    ...
    ~WithGenericMethod_saveChanges() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status saveChanges(::grpc::ServerContext* context, ::grpc::ServerReader< ::roosha::Change>* reader, ::roosha::Void* response) final override {
  ...
  class WithGenericMethod_loadChanges : public BaseClass {
   ...
   public:
    ...
    ~WithGenericMethod_loadChanges() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status loadChanges(::grpc::ServerContext* context, const ::roosha::Void* request, ::grpc::ServerWriter< ::roosha::Change>* writer) final override {
  ...
  template <class BaseClass>
  class WithStreamedUnaryMethod_knock : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithStreamedUnaryMethod_knock() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::StreamedUnaryHandler< ::roosha::Void, ::roosha::Void>(std::bind(&WithStreamedUnaryMethod_knock<BaseClass>::Streamedknock, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ~WithStreamedUnaryMethod_knock() override {
      BaseClassMustBeDerivedFromService(this);
    }
    ...
    virtual ::grpc::Status Streamedknock(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::roosha::Void,::roosha::Void>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
   ...
   public:
    WithStreamedUnaryMethod_registrate() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::StreamedUnaryHandler< ::roosha::Credentials, ::roosha::AuthenticationToken>(std::bind(&WithStreamedUnaryMethod_registrate<BaseClass>::Streamedregistrate, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status Streamedregistrate(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::roosha::Credentials,::roosha::AuthenticationToken>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
   ...
   public:
    WithStreamedUnaryMethod_authorize() {
      ::grpc::Service::MarkMethodStreamed(2,
        new ::grpc::StreamedUnaryHandler< ::roosha::Credentials, ::roosha::AuthenticationToken>(std::bind(&WithStreamedUnaryMethod_authorize<BaseClass>::Streamedauthorize, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status Streamedauthorize(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::roosha::Credentials,::roosha::AuthenticationToken>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
   ...
   public:
    WithStreamedUnaryMethod_translate() {
      ::grpc::Service::MarkMethodStreamed(3,
        new ::grpc::StreamedUnaryHandler< ::roosha::TranslationRequest, ::roosha::Translations>(std::bind(&WithStreamedUnaryMethod_translate<BaseClass>::Streamedtranslate, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status Streamedtranslate(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::roosha::TranslationRequest,::roosha::Translations>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
  class WithStreamedUnaryMethod_proposeUserTranslations : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithStreamedUnaryMethod_proposeUserTranslations() {
      ::grpc::Service::MarkMethodStreamed(4,
        new ::grpc::StreamedUnaryHandler< ::roosha::Translations, ::roosha::Void>(std::bind(&WithStreamedUnaryMethod_proposeUserTranslations<BaseClass>::StreamedproposeUserTranslations, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ~WithStreamedUnaryMethod_proposeUserTranslations() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status proposeUserTranslations(::grpc::ServerContext* context, const ::roosha::Translations* request, ::roosha::Void* response) final override {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedproposeUserTranslations(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::roosha::Translations,::roosha::Void>* server_unary_streamer) = 0;
  };
  typedef WithStreamedUnaryMethod_knock<WithStreamedUnaryMethod_registrate<WithStreamedUnaryMethod_authorize<WithStreamedUnaryMethod_translate<WithStreamedUnaryMethod_proposeUserTranslations<Service > > > > > StreamedUnaryService;
  template <class BaseClass>
  class WithSplitStreamingMethod_loadChanges : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
